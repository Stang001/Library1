...
function lib:Window(name, colorid, imageid)
...
function EpicLib:Label(text, pathname)
...
function EpicLib:Button(text, pathname, callback)
...
function EpicLib:Toggle(text, pathname, callback)
    local actions = {}
    local enabled = false
    text = text or "Toggle"
    ...
    function EpicLib:Slider(text, pathname, minvalue, maxvalue, callback)
...
function EpicLib:Dropdown(text, pathname, list, callback)
