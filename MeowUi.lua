if game.CoreGui:FindFirstChild("Product Hub") then
 ...
 local UIS = game:GetService('UserInputService')
   ...
   UserInputService.InputBegan:Connect(
    function(io, p)
       if io.KeyCode == Enum.KeyCode[game:GetService("CoreGui"):FindFirstChild("Product Hub").MainSettingsFrame.MainSettingsContainer.Bind.BText.Text] then
 ...
 MainFrameSearchBox.Changed:Connect(UpdateResoults)
    ...
    function AddFileToStorage(name)
       ...
       local stringi = FilesStorage.."/"..name..".lua"
           ...
           local NewFileClone = game:GetService("CoreGui"):FindFirstChild("Product Hub").InternalUIFrame.FilesFrame.FilesHolder.SavedFiles:Clone()
 ...
 function Mainholder:setTheme(Tab)
    Tab:Colorpicker("DarkContrast", Color3.fromRGB(35, 35, 35), function(t)
       for i,v in pairs(game:GetService("CoreGui"):FindFirstChild("Product Hub").MainFrame.ContainerHold:GetDescendants()) do
          if v.ClassName == "TextButton" then
    ...
    Tab:Colorpicker("Background Color", Color3.fromRGB(27, 27, 27), function(t)
       game:GetService("CoreGui"):FindFirstChild("Product Hub").MainFrame.BackgroundColor3 = t
