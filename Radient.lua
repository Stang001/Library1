...
local tag
local userinfo = {}
if game.CoreGui:FindFirstChild("pulawat 6680") then
   game.CoreGui:FindFirstChild("pulawat 6680"):Destroy()
end
...
RadientPaidSC.Name = "pulawat 6680"
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      function ChannelHold:Channel(text)
         ...
         function ChannelContent:Bind(text, presetbind, callback)
            ...
            KeybindText.Position = UDim2.new(0, 300, 0, 0) -- // UDim2.new(0, 316, 0, 0)
