if game.CoreGui:FindFirstChild("Capybara Hub") then
    game.CoreGui:FindFirstChild("Capybara Hub"):Destroy()
end
...
SOMEXHUBMODILE.Name = "Capybara Hub"
        ...
        game.CoreGui:FindFirstChild("Capybara Hub").Enabled = not game.CoreGui:FindFirstChild("Capybara Hub").Enabled
        end)
        do
        if game:GetService("CoreGui"):FindFirstChild("Capybara Hub") then
        end
        end

        MODILEGUISOMEXHUBHUI.Name = "Capybara Hub"
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=10162642062"
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(10162642062)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(10162642062)
...
local Library = Update:Window("Capybaray Hub","",Enum.KeyCode.RightControl);
Main = Library:Tab("General",6026568198)
Stats = Library:Tab("Auto Stats",7040410130)
Combat = Library:Tab("Combat",7251993295)
Teleport = Library:Tab("Teleport",6035190846)
Dungeon = Library:Tab("Dungeon",7044284832)
BuyItem = Library:Tab("Buy Item",6031265976)
DevilFruit = Library:Tab("Devil Fruit",7044233235)
